...
public class GlobalLoggingAspect {
    ...
    /**
     * 拦截 diff 包下所有类的所有方法，但排除当前配置包自身（避免循环或代理配置类干扰）
     */
    @Pointcut("execution(* top.bulgat.migration.diff..*(..)) && !within(top.bulgat.migration.diff.infrastructure.config..*) && !within(top.bulgat.migration.diff.domain.model..*)")
