...
- [需求分析文档](docs/requirement/需求分析文档.md) : 功能细节与状态枚举详解。
- [架构设计文档](docs/design/架构设计文档.md) : 全局宏观流转架构与部署说明。
- [分模块架构设计与详细设计](docs/design/分模块架构设计与详细设计.md) : SDK执行策略树、性能优化处理(Disruptor)与数据库设计细节。
- 其他各模块特定的设计说明书。
